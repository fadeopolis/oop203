...
public class Time implements Serializable, Cloneable, Comparable<Time> {
	...
	public enum Month {
		Januar(31), Februar(28), March(31), April(30), May(31), Juni(30),
		July(31), August(31), September(30), Oktober(31), November(30), December(31);
...
//	protected final int compareTime;
...
//    	long[] f = new long[6];
//    	f[0] = l/(12*30*24*60*60*1000);
//    	l -= f[0]*(12*30*24*60*60*1000);
//    	f[1] = l/(30*24*60*60*1000);
//    	l -= f[1]*(30*24*60*60*1000);
//    	f[2] = l/(24*60*60*1000);
//    	l -= f[2]*(24*60*60*1000);
//    	f[3] = l/(60*60*1000);
//    	l -= f[3]*(60*60*1000);
